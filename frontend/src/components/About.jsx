...
function About() {
  return (
    <div className='w-[100vw] lg:h-[70vh] min-h-[50vh] flex flex-wrap items-center justify-center gap-2 mb-[30px] mt-25 '>
        ...
        <div className='lg:w-[50%] md:w-[70%] w-[100%] h-[100%] flex  items-start justify-center flex-col px-[35px] md:px-[80px]' >
          ...
          <div className='md:text-[40px] relative text-[32px] font-semibold after:content-[""] after:w-[20%] after:absolute after:bottom-0 after:left-[0px] after:bg-[#f8961d] after:h-[5px] after:rounded-full '>We Are Maximize Your Learning Growth</div>
          <div className='text-[16]px] pt-6'>We provide a modern Learning Management System to simplify online education, track progress, and enhance student-instructor collaboration efficiently.</div>
