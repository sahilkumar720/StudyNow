...
setFilterCourses(courseData)
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <aside className={`w-[290px] h-screen overflow-y-auto bg-black fixed  top-0 left-0 p-6 py-[130px] border-r border-gray-200 shadow-md transition-transform duration-300 z-5 
      ...
      <main className="w-[100%] transition-all duration-300 py-[130px] md:pl-[300px]  flex items-start justify-center md:justify-start flex-wrap gap-6 px-[12px] grid-cols-1 md:grid-cols-2 lg:grid-cols-3 " >
        {
        filterCourses?.map((item,index)=>(
        <div className='width-[full] m-2 md:m-auto lg:m-2'>
